    ...
    return function t(e, n, i) {
        ...
        1: [function(t, e, n) {
            ...
            e.exports = function(t) {
                ...
                if (0 === e.length)
                    for (var n in t)
                        s.call(t, n) && "function" == typeof t[n] && "[object Function]" == r.call(t[n]) && e.push(n);
        ...
        2: [function(t, e, n) {
            ...
            i.prototype.addListener = function(t, e) {
                ...
                o(this._events[t]) && !this._events[t].warned && (n = a(this._maxListeners) ? i.defaultMaxListeners : this._maxListeners,
                ...
                t.Lethargy = function() {
                    function t(t, e, n, i) {
                        ...
                        this.lastUpDeltas = function() {
                            ...
                            for (n = [],
                            t = 1,
                            e = 2 * this.stability; e >= 1 ? e >= t : t >= e; e >= 1 ? t++ : t--)
                                n.push(null);
                            return n
                        }
                        .call(this),
                    ...
                    t.prototype.isInertia = function(t) {
                        ...
                        null === e[0] ? t : this.deltasTimestamp[2 * this.stability - 2] + this.delay > Date.now() && e[0] === e[2 * this.stability - 1] ? !1 : (i = e.slice(0, this.stability),
        ...
        8: [function(t, e, n) {
            (function(n) {
                for (var i = t("performance-now"), r = "undefined" == typeof window ? n : window, s = ["moz", "webkit"], o = "AnimationFrame", a = r["request" + o], l = r["cancel" + o] || r["cancelRequest" + o], u = 0; !a && u < s.length; u++)
                    a = r[s[u] + "Request" + o],
        ...
        11: [function(t, e, n) {
            ...
            i.prototype._onWheel = function(t) {
                ...
                if (!this._lethargy || this._lethargy.check(t) !== !1) {
                    ...
                    a.isFirefox && 1 == t.deltaMode && (n.deltaX *= e.firefoxMultiplier,
            ...
            i.prototype._bind = function() {
                ...
                a.hasTouch && (this.el.addEventListener("touchstart", this._onTouchStart),
        ...
        13: [function(t, e, n) {
            ...
            function o(t, e) {
                if ("function" != typeof e && null !== e)
                    throw new TypeError("Super expression must either be null or a function, not " + ("undefined" == typeof e ? "undefined" : a(e)));
              ...
              , y = function(t) {
                ...
                l(e, [{
                    ...
                    value: function() {
                        ...
                        this.options.isAnimated ? this.wrapper.style[this.transform] = "translate3d(-" + this.vars.scrollValue + "px, 0 ,0) skewX(" + this.vars.speed + "deg)" : this.wrapper.style[this.transform] = "translate3d(-" + this.vars.scrollValue + "px, 0 ,0)",
